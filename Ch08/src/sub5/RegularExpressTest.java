...
public class RegularExpressTest {
	public static void main(String[] args) {
		...
		// 정규표현식
		String patt = "b[a-z]*";						// 소문자 b로 시작했고 a ~ z 까지의 소문자 단어가 나옴 / * 0개 이상
		boolean rs1 = Pattern.matches(patt, "bat");		// b로 시작했고 소문자 a ~ z 중의 단어가 나왔기 때문에 ture
		boolean rs2 = Pattern.matches(patt, "cat");		// c로 시작했고 소문자 a ~ z 중의 단어가 나왔기 때문에 false
		...
		String p3 = "^[가-힣]*$";
		String p4 = "^[a-zA-Z0-9]*$";
		String p5 = "(01\\d{1})-(\\d{3,4})-(\\d{4})";		// 휴대폰 정규 표현식
		String p6 = "(\\w+)@(\\w+).(\\w+)";					// E-mail 정규 표현식
		
		String source = "이름:홍길동, 휴대폰1:010-1234-1004, 휴대폰2:011-123-1001, 이메일:hong@gmail.com";
